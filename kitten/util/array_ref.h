...
public:
  ...
  constexpr explicit ArrayRef(const T &OneElt) : Data(&OneElt), Length(1) {}
...
// conversions to get you to an kitten::ArrayRef, which is why we need so
// many overloads.

template <typename T>
bool operator==(kitten::ArrayRef<T> a1, kitten::ArrayRef<T> a2) {
  return a1.equals(a2);
}
...
template <typename T>
bool operator==(const std::vector<T> &a1, kitten::ArrayRef<T> a2) {
  return kitten::ArrayRef<T>(a1).equals(a2);
}
...
template <typename T>
bool operator==(kitten::ArrayRef<T> a1, const std::vector<T> &a2) {
  return a1.equals(kitten::ArrayRef<T>(a2));
}
